...
if (typeof window.SuperTabsStorageClass === 'undefined') {
  window.SuperTabsStorageClass = class SuperTabsStorage {
    constructor() {
...
if (!window.superTabsStorage) {
  window.superTabsStorage = new window.SuperTabsStorageClass();
}
